...
# The NAME variable should be of the format "sdss-datamodel_parser".
...
def run(packages, install_requires):
    ...
    setup(name=NAME,
          ...
          author_email='n.benjamin.murphy@astro.utah.edu',
          keywords='astronomy software',
          url='https://github.com/sdss/datamodel_parser',
          include_package_data=True,
          packages=packages,
          install_requires=install_requires,
          package_dir={'': 'python'},
          scripts=['bin/datamodel_parser'],
          classifiers=[
