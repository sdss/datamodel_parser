...
from datamodel_parser import __version__
...
project = 'datamodel_parser'
copyright = '{0}, {1}'.format('2019', 'N Benjamin Murphy')
...
htmlhelp_basename = '{0}pdoc'.format('datamodel_parser')
...
man_pages = [
    (master_doc, 'datamodel_parser', u'{0} Documentation'.format(project),
     [author], 1)
]
